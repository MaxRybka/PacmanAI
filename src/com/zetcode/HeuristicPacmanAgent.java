...
public class HeuristicPacmanAgent implements Agent {

    private PriorityQueue<Pair> frontier;
    ...
    private HeuristicPairComparator comparator;

    public HeuristicPacmanAgent(Pair start_pair,Board board) {
        this.start_mem = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        this.board = board;
        this.start_pair = start_pair;

        comparator = new HeuristicPairComparator(board.getTarget());

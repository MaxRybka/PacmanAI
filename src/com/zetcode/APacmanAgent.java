...
public class APacmanAgent implements Agent {
    ...
    private APairComparator comparator;

    public APacmanAgent(Pair start_pair,Board board) {
        this.start_mem = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        this.board = board;
        this.start_pair = start_pair;

        comparator = new APairComparator(board.getTarget());
